...
define('zapp_user_main', ['dart_sdk', 'flutter_sdk'], (function load__zapp_user_main(dart_sdk, flutter_sdk) {
  ...
  var T$ = {
    ...
    dynamicAnddynamicToNint: () => (T$.dynamicAnddynamicToNint = dart.constFn(dart.nullable(T$.dynamicAnddynamicToint())))(),
  ...
  dart.defineLazy(CT, {
    ...
    get C8() {
      return C[8] = dart.const({
        ...
        [Text_locale]: null,
        [Text_textDirection]: null,
        [Text_textAlign]: C[9] || CT.C9,
        [Text_strutStyle]: null,
        [Text_style]: C[10] || CT.C10,
        [Text_textSpan]: null,
        [Text_data]: "1. Toque em um dos botões abaixo"
      });
    },
    get C11() {
      return C[11] = dart.const({
        ...
        [Text_style]: C[10] || CT.C10,
        [Text_textSpan]: null,
        [Text_data]: "para executar o aplicativo."
      });
    },
    get C13() {
    ...
    get C7() {
      return C[7] = dart.constList([C[8] || CT.C8, C[11] || CT.C11, C[12] || CT.C12], framework.Widget);
    },
    get C16() {
    ...
    get C15() {
      return C[15] = dart.const({
        ...
        [Text_textSpan]: null,
        [Text_data]: "Erro ao Carregar. FUDEU"
      });
    },
    get C18() {
    ...
    get C14() {
      return C[14] = dart.constList([C[15] || CT.C15, C[17] || CT.C17], framework.Widget);
    },
    get C22() {
    ...
    get C20() {
      return C[20] = dart.const({
        ...
        [BottomNavigationBarItem_activeIcon]: C[21] || CT.C21,
        [BottomNavigationBarItem_icon]: C[21] || CT.C21
      });
    },
    get C25() {
    ...
    get C23() {
      return C[23] = dart.const({
        ...
        [BottomNavigationBarItem_tooltip]: null,
        [BottomNavigationBarItem_backgroundColor]: null,
        [BottomNavigationBarItem_label]: "Beers",
    ...
    get C26() {
      return C[26] = dart.const({
        ...
        [BottomNavigationBarItem_activeIcon]: C[27] || CT.C27,
        [BottomNavigationBarItem_icon]: C[27] || CT.C27
      });
    },
    get C31() {
    ...
    get C29() {
      return C[29] = dart.const({
        ...
        [BottomNavigationBarItem_tooltip]: null,
        [BottomNavigationBarItem_backgroundColor]: null,
        [BottomNavigationBarItem_label]: "Cannabis",
        [BottomNavigationBarItem_activeIcon]: C[30] || CT.C30,
        [BottomNavigationBarItem_icon]: C[30] || CT.C30
      });
    },
    get C19() {
      return C[19] = dart.constList([C[20] || CT.C20, C[23] || CT.C23, C[26] || CT.C26, C[29] || CT.C29], bottom_navigation_bar_item.BottomNavigationBarItem);
    },
    get C32() {
      return C[32] = dart.constList([], dart.dynamic);
    },
    get C33() {
      return C[33] = dart.constList(["Nome", "Estilo", "IBU"], core.String);
    },
    get C34() {
      return C[34] = dart.constList(["name", "style", "ibu"], core.String);
    },
    get C35() {
  ...
  main.DataService = class DataService extends core.Object {
    ...
    carregar(index) {
      let funcoes = T$.JSArrayOfVoidTovoid().of([dart.bind(this, 'makeCoffee'), dart.bind(this, 'makeBeer'), dart.bind(this, 'makeNations'), dart.bind(this, 'makeCannabis')]);
      this.tableStateNotifier.value = new (T$.IdentityMapOfString$dynamic()).from(["status", main.TableStatus.loading, "dataObjects", [], "columnNames", []]);
      funcoes[$_get](core.int.as(index))();
    }
    makeCoffee() {
      let coffeesUri = core._Uri.new({scheme: "https", host: "random-data-api.com", path: "api/coffee/random_coffee", queryParameters: new (T$.IdentityMapOfString$dynamic()).from(["size", "8"])});
      try {
        http.read(coffeesUri).then(core.Null, dart.fn(jsonString => {
          let coffeesJson = convert.jsonDecode(jsonString);
          this.tableStateNotifier.value = new (T$.IdentityMapOfString$dynamic()).from(["status", main.TableStatus.ready, "dataObjects", coffeesJson, "columnNames", T$.JSArrayOfString().of(["Blend Name", "Origin", "Variety"]), "propertyNames", T$.JSArrayOfString().of(["blend_name", "origin", "variety"])]);
        }, T$.StringToNull()));
      } catch (e) {
        let err = dart.getThrown(e);
        if (core.Object.is(err)) {
          this.tableStateNotifier.value = new (T$.IdentityMapOfString$dynamic()).from(["status", main.TableStatus.error, "dataObjects", [], "columnNames", []]);
        } else
          throw e;
      }
    }
    makeNations() {
      return async.async(dart.void, (function* makeNations() {
        let nationsUri = core._Uri.new({scheme: "https", host: "random-data-api.com", path: "api/nation/random_nation", queryParameters: new (T$.IdentityMapOfString$dynamic()).from(["size", "8"])});
        try {
          let jsonString = (yield http.read(nationsUri));
          let nationsJson = convert.jsonDecode(jsonString);
          this.tableStateNotifier.value = new (T$.IdentityMapOfString$dynamic()).from(["status", main.TableStatus.ready, "dataObjects", nationsJson, "columnNames", T$.JSArrayOfString().of(["Nationality", "Language", "Capital"]), "propertyNames", T$.JSArrayOfString().of(["nationality", "language", "capital"])]);
        } catch (e) {
          let err = dart.getThrown(e);
          if (core.Object.is(err)) {
            this.tableStateNotifier.value = new (T$.IdentityMapOfString$dynamic()).from(["status", main.TableStatus.error, "dataObjects", [], "columnNames", []]);
    ...
    makeBeer() {
      let beersUri = core._Uri.new({scheme: "https", host: "random-data-api.com", path: "api/beer/random_beer", queryParameters: new (T$.IdentityMapOfString$dynamic()).from(["size", "8"])});
      try {
        http.read(beersUri).then(core.Null, dart.fn(jsonString => {
          let beersJson = convert.jsonDecode(jsonString);
          this.tableStateNotifier.value = new (T$.IdentityMapOfString$dynamic()).from(["status", main.TableStatus.ready, "dataObjects", beersJson, "columnNames", T$.JSArrayOfString().of(["Nome", "Estilo", "IBU"]), "propertyNames", T$.JSArrayOfString().of(["name", "style", "ibu"])]);
        }, T$.StringToNull()));
      } catch (e) {
        let err = dart.getThrown(e);
        if (core.Object.is(err)) {
    ...
    makeCannabis() {
      let cannabisUri = core._Uri.new({scheme: "https", host: "random-data-api.com", path: "api/cannabis/random_cannabis", queryParameters: new (T$.IdentityMapOfString$dynamic()).from(["size", "8"])});
      http.read(cannabisUri).then(core.Null, dart.fn(jsonString => {
        let cannabisJson = convert.jsonDecode(jsonString);
        this.tableStateNotifier.value = new (T$.IdentityMapOfString$dynamic()).from(["status", main.TableStatus.ready, "dataObjects", cannabisJson, "columnNames", T$.JSArrayOfString().of(["Strain", "Health Benefits", "Abbreviation"]), "propertyNames", T$.JSArrayOfString().of(["strain", "health_benefit", "cannabinoid_abbreviation"])]);
      }, T$.StringToNull()));
    }
  ...
  (main.DataService.new = function() {
    this[tableStateNotifier] = new (T$.ValueNotifierOfMapOfString$dynamic()).new(new (T$.IdentityMapOfString$dynamic()).from(["status", main.TableStatus.idle, "dataObjects", [], "columnNames", []]));
    ;
  ...
  dart.setMethodSignature(main.DataService, () => ({
    ...
    makeNations: dart.fnType(async.Future$(dart.void), []),
    makeBeer: dart.fnType(dart.void, []),
    makeCannabis: dart.fnType(dart.void, [])
  }));
  ...
  main.MyApp = class MyApp extends framework.StatelessWidget {
    build(context) {
      return new app.MaterialApp.new({theme: theme_data.ThemeData.new({primarySwatch: colors.Colors.lightBlue}), debugShowCheckedModeBanner: false, home: new scaffold.Scaffold.new({appBar: new app_bar.AppBar.new({title: C[6] || CT.C6}), body: new basic.Center.new({child: new basic.Column.new({mainAxisAlignment: flex.MainAxisAlignment.center, children: T$.JSArrayOfWidget().of([new (T$.ValueListenableBuilderOfMapOfString$dynamic()).new({valueListenable: main.dataService.tableStateNotifier, builder: dart.fn((_, value, __) => {
                    switch (value[$_get]("status")) {
                      case C[2] || CT.C2:
                        {
                          return new basic.Row.new({mainAxisAlignment: flex.MainAxisAlignment.center, children: T$.JSArrayOfWidget().of([new basic.Column.new({children: C[7] || CT.C7})])});
                        }
                      case C[3] || CT.C3:
                        {
                      ...
                      case C[4] || CT.C4:
                        {
                          return new main.DataTableWidget.new({jsonObjects: core.List.as(value[$_get]("dataObjects")), propertyNames: T$.ListOfString().as(value[$_get]("propertyNames")), columnNames: T$.ListOfString().as(value[$_get]("columnNames"))});
                        }
                      case C[5] || CT.C5:
                        {
                          return new basic.Row.new({mainAxisAlignment: flex.MainAxisAlignment.center, children: C[14] || CT.C14});
                        }
                    }
  ...
  main.NewNavBar = class NewNavBar extends framework$.HookWidget {
    ...
    build(context) {
      ...
      return new bottom_navigation_bar.BottomNavigationBar.new({type: bottom_navigation_bar.BottomNavigationBarType.fixed, onTap: dart.fn(index => {
          ...
          state.value = index;
          t5 = index;
          dart.dsend(this, _itemSelectedCallback, [t5]);
        }, T$.intTovoid()), currentIndex: state.value, items: C[19] || CT.C19});
    }
  };
  (main.NewNavBar.new = function(opts) {
    let t5;
    let itemSelectedCallback = opts && 'itemSelectedCallback' in opts ? opts.itemSelectedCallback : null;
    this[_itemSelectedCallback] = (t5 = itemSelectedCallback, t5 == null ? dart.wrapType(core.int) : t5);
  ...
  var _compareMaker = dart.privateName(main, "_compareMaker");
  main.DataTableWidget = class DataTableWidget extends framework$.HookWidget {
    get jsonObjects() {
    ...
    static ['_#new#tearOff'](opts) {
      let jsonObjects = opts && 'jsonObjects' in opts ? opts.jsonObjects : C[32] || CT.C32;
      let columnNames = opts && 'columnNames' in opts ? opts.columnNames : C[33] || CT.C33;
      let propertyNames = opts && 'propertyNames' in opts ? opts.propertyNames : C[34] || CT.C34;
      return new main.DataTableWidget.new({jsonObjects: jsonObjects, columnNames: columnNames, propertyNames: propertyNames});
    }
    [_compareMaker](property, asc) {
      return asc ? dart.fn((a, b) => core.int.as(dart.dsend(dart.dsend(a, '_get', [property]), 'compareTo', [dart.dsend(b, '_get', [property])])), T$.dynamicAnddynamicToint()) : dart.fn((a, b) => core.int.as(dart.dsend(dart.dsend(b, '_get', [property]), 'compareTo', [dart.dsend(a, '_get', [property])])), T$.dynamicAnddynamicToint());
    }
    build(context) {
      let internalState = hooks.useState(T$.MapOfString$ObjectN(), new (T$.IdentityMapOfString$ObjectN()).from(["asc", true, "sortColumn", null, "objects", this.jsonObjects]));
      return new single_child_scroll_view.SingleChildScrollView.new({child: new data_table.DataTable.new({sortAscending: core.bool.as(internalState.value[$_get]("asc")), sortColumnIndex: internalState.value[$_get]("sortColumn") != null ? core.int.as(internalState.value[$_get]("sortColumn")) : null, columns: this.columnNames[$map](data_table.DataColumn, dart.fn(name => new data_table.DataColumn.new({onSort: dart.fn((index, isAscending) => {
              let compare = this[_compareMaker](this.propertyNames[$_get](index), isAscending);
              this.jsonObjects[$sort](T$.dynamicAnddynamicToNint().as(compare));
              internalState.value = new (T$.IdentityMapOfString$ObjectN()).from(["objects", this.jsonObjects, "sortColumn", index, "asc", isAscending]);
  ...
  dart.setMethodSignature(main.DataTableWidget, () => ({
    ...
    [_compareMaker]: dart.fnType(dart.dynamic, [core.String, core.bool]),
    build: dart.fnType(framework.Widget, [framework.BuildContext])
  }));
