...
define('zapp_user_main', ['dart_sdk', 'flutter_sdk'], (function load__zapp_user_main(dart_sdk, flutter_sdk) {
  ...
  dart.defineLazy(CT, {
    ...
    get C1() {
      return C[1] = dart.constList([3, 5, 7], core.int);
    },
    get C2() {
  ...
  dart.setStaticFieldSignature(widgets.Selection, () => ['selection']);
  dart.defineLazy(widgets.Selection, {
    /*widgets.Selection.selection*/get selection() {
      return C[1] || CT.C1;
    }
  }, false);
  var load = dart.privateName(widgets, "MyApp.load");
  ...
  (widgets.MyApp.new = function() {
    this[load] = widgets.Selection.selection;
  ...
  dart.setFieldSignature(widgets.MyApp, () => ({
    ...
    load: dart.finalFieldType(core.List$(core.int))
  }));
  var itemSelectedCallback$ = dart.privateName(widgets, "NewNavBar.itemSelectedCallback");
  ...
  widgets.NewNavBar = class NewNavBar extends framework$.HookWidget {
    ...
    build(context) {
      ...
      return new bottom_navigation_bar.BottomNavigationBar.new({selectedItemColor: colors.Colors.pink, onTap: dart.fn(index => {
          let t0;
          state.value = index;
          t0 = index;
          this.itemSelectedCallback(t0);
  ...
  dart.setFieldSignature(widgets.NewNavBar, () => ({
    ...
    itemSelectedCallback: dart.finalFieldType(dart.fnType(dart.dynamic, [core.int]))
  }));
  ...
  data_service.DataService = class DataService extends core.Object {
    ...
    set numberOfItems(n) {
      this[_numberOfItems] = core.int.as(dart.dtest(dart.dsend(n, '<=', [0])) ? 3 : dart.dtest(dart.dsend(n, '>', [15])) ? 15 : n);
    }
    get numberOfItems() {
    ...
    carregar(index) {
      ...
      switch (index) {
        case 0:
          {
            itemType = data_service.ItemType.coffee;
            propertyNames = T$.JSArrayOfString().of(["blend_name", "origin", "variety"]);
            columnNames = T$.JSArrayOfString().of(["Nome", "Origem", "Tipo"]);
            path = "api/coffee/random_coffee";
            break;
          }
        case 1:
          {
            itemType = data_service.ItemType.beer;
            propertyNames = T$.JSArrayOfString().of(["name", "style", "ibu"]);
            columnNames = T$.JSArrayOfString().of(["Nome", "Estilo", "IBU"]);
            path = "api/beer/random_beer";
            break;
          }
        case 2:
          {
            itemType = data_service.ItemType.nation;
            propertyNames = T$.JSArrayOfString().of(["nationality", "capital", "language", "national_sport"]);
            columnNames = T$.JSArrayOfString().of(["Nome", "Capital", "Idioma", "Esporte"]);
      ...
      let uri = core._Uri.new({scheme: "https", host: "random-data-api.com", path: path, queryParameters: new (T$.IdentityMapOfString$dynamic()).from(["size", dart.str(this[_numberOfItems])])});
  ...
  dart.setStaticFieldSignature(data_service.DataService, () => ['MAX_N_ITEMS', 'MIN_N_ITEMS', 'DEFAULT_N_ITEMS']);
  dart.defineLazy(data_service.DataService, {
    /*data_service.DataService.MAX_N_ITEMS*/get MAX_N_ITEMS() {
      return 15;
    },
    /*data_service.DataService.MIN_N_ITEMS*/get MIN_N_ITEMS() {
      return 3;
    },
    /*data_service.DataService.DEFAULT_N_ITEMS*/get DEFAULT_N_ITEMS() {
      return 7;
    }
  }, false);
