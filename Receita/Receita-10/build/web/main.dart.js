...
define('zapp_user_main', ['dart_sdk', 'flutter_sdk'], (function load__zapp_user_main(dart_sdk, flutter_sdk) {
  ...
  const overscroll_indicator = flutter_sdk.src__widgets__overscroll_indicator;
  ...
  var filtrador = Object.create(dart.library);
  ...
  dart.defineLazy(CT, {
    ...
    get C1() {
      return C[1] = dart.constList([3, 5, 15], core.int);
    },
    get C2() {
      return C[2] = dart.const({
        ...
        [Text_style]: null,
        [Text_textSpan]: null,
        [Text_data]: "Final de POO com Dart"
      });
    },
    get C3() {
    ...
    get C8() {
      return C[8] = dart.const({
        ...
        [BottomNavigationBarItem_label]: "Computers",
    ...
    get C11() {
      return C[11] = dart.const({
        ...
        [BottomNavigationBarItem_tooltip]: null,
        [BottomNavigationBarItem_backgroundColor]: null,
        [BottomNavigationBarItem_label]: "Vehicles",
    ...
    get C14() {
      return C[14] = dart.const({
        ...
        [BottomNavigationBarItem_tooltip]: null,
        [BottomNavigationBarItem_backgroundColor]: null,
        [BottomNavigationBarItem_label]: "foods",
        [BottomNavigationBarItem_activeIcon]: C[15] || CT.C15,
        [BottomNavigationBarItem_icon]: C[15] || CT.C15
      });
    },
    get C7() {
      return C[7] = dart.constList([C[8] || CT.C8, C[11] || CT.C11, C[14] || CT.C14], bottom_navigation_bar_item.BottomNavigationBarItem);
    },
    get C17() {
      return C[17] = dart.constList([], dart.dynamic);
    },
    get C18() {
      return C[18] = dart.constList([], core.String);
    },
    get C19() {
      return C[19] = dart.constList([C[3] || CT.C3, C[4] || CT.C4, C[5] || CT.C5, C[6] || CT.C6], data_service.TableStatus);
    },
    get C21() {
      return C[21] = dart.const({
        __proto__: data_service.ItemType.prototype,
        [_Enum__name]: "computer",
        [_Enum_index]: 0
      });
    },
    get C22() {
    ...
    get C20() {
      return C[20] = dart.constList([C[21] || CT.C21, C[22] || CT.C22, C[23] || CT.C23, C[24] || CT.C24], data_service.ItemType);
    },
    get C25() {
  ...
  var I = [
    ...
    "file:///zapp/project/lib/util/filtrador.dart",
  ...
  widgets.Selection = class Selection extends core.Object {
    static ['_#new#tearOff']() {
      return new widgets.Selection.new();
    }
  };
  (widgets.Selection.new = function() {
    ;
  }).prototype = widgets.Selection.prototype;
  dart.addTypeTests(widgets.Selection);
  dart.addTypeCaches(widgets.Selection);
  dart.setLibraryUri(widgets.Selection, I[0]);
  dart.setStaticFieldSignature(widgets.Selection, () => ['options']);
  dart.defineLazy(widgets.Selection, {
    /*widgets.Selection.options*/get options() {
      return C[1] || CT.C1;
    }
  }, false);
  widgets.CustomScroll = class CustomScroll extends scroll_configuration.ScrollBehavior {
    buildViewportChrome(context, axisDirection, child) {
      return new overscroll_indicator.GlowingOverscrollIndicator.new({axisDirection: axisDirection, child: child, color: colors.Colors.pink, showTrailing: false, showLeading: false});
    }
    static ['_#new#tearOff']() {
      return new widgets.CustomScroll.new();
    }
  };
  (widgets.CustomScroll.new = function() {
    widgets.CustomScroll.__proto__.new.call(this);
    ;
  }).prototype = widgets.CustomScroll.prototype;
  dart.addTypeTests(widgets.CustomScroll);
  dart.addTypeCaches(widgets.CustomScroll);
  dart.setMethodSignature(widgets.CustomScroll, () => ({
    __proto__: dart.getMethods(widgets.CustomScroll.__proto__),
    buildViewportChrome: dart.fnType(framework.Widget, [framework.BuildContext, basic_types.AxisDirection, framework.Widget])
  }));
  dart.setLibraryUri(widgets.CustomScroll, I[0]);
  var loadOptions = dart.privateName(widgets, "MyApp.loadOptions");
  ...
  widgets.MyApp = class MyApp extends framework.StatelessWidget {
    ...
    build(context) {
      return new app.MaterialApp.new({theme: theme_data.ThemeData.new({primarySwatch: colors.Colors.lightBlue}), debugShowCheckedModeBanner: false, home: new scaffold.Scaffold.new({appBar: new app_bar.AppBar.new({title: C[2] || CT.C2, actions: T$.JSArrayOfWidget().of([new (T$.PopupMenuButtonOfint()).new({itemBuilder: dart.fn(_ => this.loadOptions[$map](T$.PopupMenuItemOfint(), dart.fn(num => new (T$.PopupMenuItemOfint()).new({value: num, child: new text.Text.new("Carregar " + dart.str(num) + " itens por vez")}), T$.intToPopupMenuItemOfint()))[$toList](), T$.BuildContextToListOfPopupMenuItemOfint()), onSelected: dart.fn(number => {
              ...
              switch (value[$_get]("status")) {
                case C[3] || CT.C3:
                  {
                    return new basic.Center.new({child: new text.Text.new("1.Toque em algum botão abaixo")});
                  }
                case C[4] || CT.C4:
                  {
                ...
                case C[5] || CT.C5:
                  {
                    return new single_child_scroll_view.SingleChildScrollView.new({child: new widgets.DataTableWidget.new({jsonObjects: core.List.as(value[$_get]("dataObjects")), propertyNames: T$.ListOfString().as(value[$_get]("propertyNames")), columnNames: T$.ListOfString().as(value[$_get]("columnNames")), onSearchChanged: dart.fn(query => {
                        }, T$.StringToNull())})});
                  }
                case C[6] || CT.C6:
                  {
                    return new text.Text.new("Erro ao carregar. FUDEU");
                  }
              }
  ...
  (widgets.MyApp.new = function() {
    this[loadOptions] = widgets.Selection.options;
  ...
  dart.setFieldSignature(widgets.MyApp, () => ({
    ...
    loadOptions: dart.finalFieldType(core.List$(core.int))
  }));
  ...
  widgets.NewNavBar = class NewNavBar extends framework$.HookWidget {
    ...
    build(context) {
      ...
      return new bottom_navigation_bar.BottomNavigationBar.new({onTap: dart.fn(index => {
        ...
        }, T$.intTovoid()), currentIndex: state.value, items: C[7] || CT.C7});
    }
  };
  ...
  var onSearchChanged$ = dart.privateName(widgets, "DataTableWidget.onSearchChanged");
  widgets.DataTableWidget = class DataTableWidget extends framework$.HookWidget {
    get jsonObjects() {
    ...
    set onSearchChanged(value) {
      super.onSearchChanged = value;
    }
    static ['_#new#tearOff'](opts) {
      let jsonObjects = opts && 'jsonObjects' in opts ? opts.jsonObjects : C[17] || CT.C17;
      let columnNames = opts && 'columnNames' in opts ? opts.columnNames : C[18] || CT.C18;
      let propertyNames = opts && 'propertyNames' in opts ? opts.propertyNames : C[18] || CT.C18;
      let onSearchChanged = opts && 'onSearchChanged' in opts ? opts.onSearchChanged : null;
      return new widgets.DataTableWidget.new({jsonObjects: jsonObjects, columnNames: columnNames, propertyNames: propertyNames, onSearchChanged: onSearchChanged});
    }
    build(context) {
      let sortAscending = hooks.useState(core.bool, true);
      let sortColumnIndex = hooks.useState(core.int, 0);
      let searchQuery = hooks.useState(core.String, "");
      let filteredObjects = this.jsonObjects[$where](dart.fn(obj => this.propertyNames[$any](dart.fn(propName => core.bool.as(dart.dsend(dart.dsend(dart.dsend(obj, '_get', [propName]), 'toLowerCase', []), 'contains', [searchQuery.value[$toLowerCase]()])), T$.StringTobool())), T$.dynamicTobool()))[$toList]();
      return new basic.Center.new({child: new basic.Column.new({children: T$.JSArrayOfWidget().of([new text_field.TextField.new({decoration: new input_decorator.InputDecoration.new({hintText: "Search..."}), onChanged: dart.fn(value => {
                let t0;
                searchQuery.value = value;
                t0 = value;
                this.onSearchChanged(t0);
              }, T$.StringTovoid())}), new data_table.DataTable.new({sortAscending: sortAscending.value, sortColumnIndex: sortColumnIndex.value, columns: this.columnNames[$map](data_table.DataColumn, dart.fn(name => new data_table.DataColumn.new({onSort: dart.fn((columnIndex, ascending) => {
                  sortColumnIndex.value = columnIndex;
                  sortAscending.value = !sortAscending.value;
                  data_service.dataService.ordenarEstadoAtual(this.propertyNames[$_get](columnIndex), sortAscending.value);
                }, T$.intAndboolTovoid()), label: new basic.Expanded.new({child: new text.Text.new(name, {style: new text_style.TextStyle.new({fontStyle: ui.FontStyle.italic})})})}), T$.StringToDataColumn()))[$toList](), rows: filteredObjects[$map](data_table.DataRow, dart.fn(obj => new data_table.DataRow.new({cells: this.propertyNames[$map](data_table.DataCell, dart.fn(propName => new data_table.DataCell.new(new text.Text.new(core.String.as(dart.dsend(obj, '_get', [propName])))), T$.StringToDataCell()))[$toList]()}), T$.dynamicToDataRow()))[$toList]()})])})});
    }
  };
  ...
  dart.setFieldSignature(widgets.DataTableWidget, () => ({
    ...
    onSearchChanged: dart.finalFieldType(dart.fnType(dart.dynamic, [core.String]))
  }));
  ...
  data_service.ItemType = class ItemType extends core._Enum {
    ...
    get columns() {
      return this === data_service.ItemType.computer ? T$.JSArrayOfString().of(["Platform", "Type", "Operational system", "stack"]) : this === data_service.ItemType.vehicle ? T$.JSArrayOfString().of(["Model", "Color", "Streaming", "Type of fuel"]) : this === data_service.ItemType.food ? T$.JSArrayOfString().of(["Dish", "Ingredients", "Measurement"]) : T$.JSArrayOfString().of([]);
    }
    get properties() {
      return this === data_service.ItemType.computer ? T$.JSArrayOfString().of(["platform", "type", "os", "stack"]) : this === data_service.ItemType.vehicle ? T$.JSArrayOfString().of(["make_and_model", "color", "transmission", "fuel_type"]) : this === data_service.ItemType.food ? T$.JSArrayOfString().of(["dish", "ingredient", "measurement"]) : T$.JSArrayOfString().of([]);
    }
  };
  ...
  dart.setGetterSignature(data_service.ItemType, () => ({
    __proto__: dart.getGetters(data_service.ItemType.__proto__),
    asString: core.String,
    columns: core.List$(core.String),
    properties: core.List$(core.String)
  }));
  dart.setLibraryUri(data_service.ItemType, I[2]);
  dart.setStaticFieldSignature(data_service.ItemType, () => ['values', 'computer', 'food', 'vehicle', 'none']);
  dart.defineLazy(data_service.ItemType, {
    /*data_service.ItemType.values*/get values() {
      return C[20] || CT.C20;
    },
    /*data_service.ItemType.computer*/get computer() {
      return C[21] || CT.C21;
    },
    /*data_service.ItemType.food*/get food() {
      return C[22] || CT.C22;
    },
    /*data_service.ItemType.vehicle*/get vehicle() {
      return C[23] || CT.C23;
    },
  ...
  data_service.DataService = class DataService extends core.Object {
    ...
    static get MAX_N_ITEMS() {
      return data_service.DataService.values[$_get](2);
    }
    static get MIN_N_ITEMS() {
      return data_service.DataService.values[$_get](0);
    }
    static get DEFAULT_N_ITEMS() {
      return data_service.DataService.values[$_get](1);
    }
    set numberOfItems(n) {
      this[_numberOfItems] = core.int.as(dart.dtest(dart.dsend(n, '<', [0])) ? data_service.DataService.MIN_N_ITEMS : dart.dtest(dart.dsend(n, '>', [data_service.DataService.MAX_N_ITEMS])) ? data_service.DataService.MAX_N_ITEMS : n);
    }
    get numberOfItems() {
      return this[_numberOfItems];
    }
    carregar(index) {
      let params = T$.JSArrayOfItemType().of([data_service.ItemType.computer, data_service.ItemType.vehicle, data_service.ItemType.food]);
      this.carregarPorTipo(params[$_get](core.int.as(index)));
    }
    ordenarEstadoAtual(propriedade, cresc = true) {
      let t4;
      let objetos = core.List.as((t4 = this.tableStateNotifier.value[$_get]("dataObjects"), t4 == null ? [] : t4));
      if (objetos[$isEmpty]) return;
      let ord = new ordenador.Ordenador.new();
      let objetosOrdenados = [];
      let crescente = cresc;
      function precisaTrocar(atual, proximo) {
        let ordemCorreta = crescente ? [atual, proximo] : [proximo, atual];
        return core.bool.as(dart.dsend(dart.dsend(dart.dsend(ordemCorreta[$_get](0), '_get', [propriedade]), 'compareTo', [dart.dsend(ordemCorreta[$_get](1), '_get', [propriedade])]), '>', [0]));
      }
      dart.fn(precisaTrocar, T$.dynamicAnddynamicTobool());
      objetosOrdenados = ord.ssOrdenar(objetos, precisaTrocar);
      this.emitirEstadoOrdenado(objetosOrdenados, propriedade);
    }
    filtrarEstadoAtual(filtro) {
      let t4;
      let objetos = core.List.as((t4 = this.tableStateNotifier.value[$_get]("previousObjects"), t4 == null ? [] : t4));
      if (objetos[$_equals]([])) return;
      let propriedades = core.List.as(this.tableStateNotifier.value[$_get]("propertyNames"));
      let fil = new filtrador.Filtrador.new();
      let d = new data_service.DecididorFiltroJSON.new(propriedades);
      let objetosFiltrados = fil.filtrar(objetos, filtro, dart.bind(d, 'dentroDoFiltro'));
      this.emitirEstadoFiltrado(objetos, objetosFiltrados, filtro);
    }
    ...
    montarUri(type) {
      return core._Uri.new({scheme: "https", host: "random-data-api.com", path: "api/" + type.asString + "/random_" + type.asString, queryParameters: new (T$.IdentityMapOfString$dynamic()).from(["size", dart.str(this[_numberOfItems])])});
    }
    acessarApi(uri) {
      return async.async(core.List, (function* acessarApi() {
        ...
        json = (() => {
          ...
          t4[$addAll](core.Iterable.as(json));
          return t4;
        })();
        return T$.FutureOrOfList().as(json);
      }).bind(this));
    }
    emitirEstadoFiltrado(objetosOriginais, objetosFiltrados, filtro) {
      let estado = T$.LinkedHashMapOfString$dynamic().from(this.tableStateNotifier.value);
      estado[$_set]("previousObjects", objetosOriginais);
      estado[$_set]("dataObjects", objetosFiltrados);
      estado[$_set]("filterCriteria", filtro);
      this.tableStateNotifier.value = estado;
    }
    ...
    emitirEstadoPronto(type, json) {
      this.tableStateNotifier.value = new (T$.IdentityMapOfString$dynamic()).from(["itemType", type, "status", data_service.TableStatus.ready, "dataObjects", json, "propertyNames", type.properties, "columnNames", type.columns]);
    }
  ...
  (data_service.DataService.new = function() {
    this[_numberOfItems] = data_service.DataService.DEFAULT_N_ITEMS;
  ...
  dart.setMethodSignature(data_service.DataService, () => ({
    ...
    carregar: dart.fnType(dart.void, [dart.dynamic]),
    ordenarEstadoAtual: dart.fnType(dart.void, [core.String], [core.bool]),
    filtrarEstadoAtual: dart.fnType(dart.void, [core.String]),
    ...
    emitirEstadoFiltrado: dart.fnType(dart.void, [core.List, core.List, core.String]),
  ...
  dart.setSetterSignature(data_service.DataService, () => ({
    ...
    numberOfItems: dart.dynamic
  }));
  dart.setStaticGetterSignature(data_service.DataService, () => ['MAX_N_ITEMS', 'MIN_N_ITEMS', 'DEFAULT_N_ITEMS']);
  ...
  dart.setStaticFieldSignature(data_service.DataService, () => ['values']);
  dart.defineLazy(data_service.DataService, {
    /*data_service.DataService.values*/get values() {
      return T$.JSArrayOfint().of([3, 7, 15]);
    }
  }, false);
  var prop$ = dart.privateName(data_service, "DecididorJson.prop");
  var crescente$ = dart.privateName(data_service, "DecididorJson.crescente");
  data_service.DecididorJson = class DecididorJson extends core.Object {
    get prop() {
      return this[prop$];
    }
    set prop(value) {
    ...
    static ['_#new#tearOff'](prop, crescente = true) {
      return new data_service.DecididorJson.new(prop, crescente);
    }
    precisaTrocarAtualPeloProximo(atual, proximo, crescente) {
      try {
        let ordemCorreta = crescente ? [atual, proximo] : [proximo, atual];
        return core.bool.as(dart.dsend(dart.dsend(dart.dsend(ordemCorreta[$_get](0), '_get', [this.prop]), 'compareTo', [dart.dsend(ordemCorreta[$_get](1), '_get', [this.prop])]), '>', [0]));
      } catch (e) {
  ...
  (data_service.DecididorJson.new = function(prop, crescente = true) {
    this[prop$] = prop;
    this[crescente$] = crescente;
    ;
  }).prototype = data_service.DecididorJson.prototype;
  dart.addTypeTests(data_service.DecididorJson);
  dart.addTypeCaches(data_service.DecididorJson);
  data_service.DecididorJson[dart.implements] = () => [ordenador.Decididor];
  dart.setMethodSignature(data_service.DecididorJson, () => ({
    __proto__: dart.getMethods(data_service.DecididorJson.__proto__),
    precisaTrocarAtualPeloProximo: dart.fnType(core.bool, [dart.dynamic, dart.dynamic, core.bool])
  }));
  dart.setLibraryUri(data_service.DecididorJson, I[2]);
  dart.setFieldSignature(data_service.DecididorJson, () => ({
    __proto__: dart.getFields(data_service.DecididorJson.__proto__),
    prop: dart.finalFieldType(core.String),
    crescente: dart.finalFieldType(core.bool)
  }));
  var propriedades$ = dart.privateName(data_service, "DecididorFiltroJSON.propriedades");
  filtrador.DecididorFiltro = class DecididorFiltro extends core.Object {};
  (filtrador.DecididorFiltro.new = function() {
    ;
  }).prototype = filtrador.DecididorFiltro.prototype;
  dart.addTypeTests(filtrador.DecididorFiltro);
  dart.addTypeCaches(filtrador.DecididorFiltro);
  dart.setLibraryUri(filtrador.DecididorFiltro, I[3]);
  data_service.DecididorFiltroJSON = class DecididorFiltroJSON extends filtrador.DecididorFiltro {
    get propriedades() {
      return this[propriedades$];
    }
    set propriedades(value) {
      super.propriedades = value;
    }
    static ['_#new#tearOff'](propriedades) {
      return new data_service.DecididorFiltroJSON.new(propriedades);
    }
    dentroDoFiltro(objeto, filtro) {
      let achouAoMenosUm = false;
      for (let i = 0; i < this.propriedades[$length] - 1; i = i + 1) {
        achouAoMenosUm = dart.dtest(dart.dsend(dart.dsend(objeto, '_get', [this.propriedades[$_get](i)]), 'contains', [filtro])) ? true : false;
        if (achouAoMenosUm) break;
      }
      return achouAoMenosUm;
    }
  };
  (data_service.DecididorFiltroJSON.new = function(propriedades) {
    this[propriedades$] = propriedades;
    ;
  }).prototype = data_service.DecididorFiltroJSON.prototype;
  dart.addTypeTests(data_service.DecididorFiltroJSON);
  dart.addTypeCaches(data_service.DecididorFiltroJSON);
  dart.setMethodSignature(data_service.DecididorFiltroJSON, () => ({
    __proto__: dart.getMethods(data_service.DecididorFiltroJSON.__proto__),
    dentroDoFiltro: dart.fnType(core.bool, [dart.dynamic, dart.dynamic])
  }));
  dart.setLibraryUri(data_service.DecididorFiltroJSON, I[2]);
  dart.setFieldSignature(data_service.DecididorFiltroJSON, () => ({
    __proto__: dart.getFields(data_service.DecididorFiltroJSON.__proto__),
    propriedades: dart.finalFieldType(core.List)
  }));
  dart.defineLazy(data_service, {
    /*data_service.values*/get values() {
      return T$.JSArrayOfint().of([3, 7, 15]);
    },
    set values(value) {},
    ...
    class HookState extends Object_Diagnosticable$36 {
      ...
      markMayNeedRebuild() {
        ...
        if (dart.nullCheck(this[_element])[_isOptionalRebuild] !== false) {
          t6 = dart.nullCheck(this[_element]);
          (() => {
            t6[_isOptionalRebuild] = true;
            t6[_shouldRebuildQueue].add(new (T$._EntryOfVoidTobool()).new(dart.bind(this, 'shouldRebuild')));
            t6.markNeedsBuild();
            return t6;
          })();
        }
        if (!dart.nullCheck(this[_element]).dirty) dart.assertFailed("Bad state", I[4], 280, 12, "_element!.dirty");
      }
      setState(fn) {
        let t6;
        fn();
  ...
  framework$.HookElement[dart.mixinOn] = ComponentElement => class HookElement extends ComponentElement {
    ...
    get debugHooks() {
      ;
      return (() => {
        let t6 = T$.JSArrayOfHookStateOfObjectN$HookOfObjectN().of([]);
    ...
    [_use](R, hook) {
      ...
      if (this[_currentHookState$] == null) {
        ...
        if (framework$.Hook.shouldPreserveState(previousHook, hook)) {
          t7 = dart.nullCheck(this[_currentHookState$]).value;
          (() => {
            t7[_hook$] = hook;
            t7.didUpdateHook(previousHook);
            return t7;
          })();
        } else {
    ...
    dependOnInheritedWidgetOfExactType(T, opts) {
      ...
      if (!!this[_debugIsInitHook$]) dart.assertFailed("Cannot listen to inherited widgets inside HookState.initState." + " Use HookState.build instead", I[4], 478, 7, "!_debugIsInitHook");
  ...
  framework$['_extension#0|_createHookState'] = function _extension$350$124_createHookState(R, $this, hook) {
    ...
    if (!dart.fn(() => {
      ...
      return true;
    }, T$.VoidTobool())()) dart.assertFailed("", I[4], 310, 12, "() {\n      _debugIsInitHook = true;\n      return true;\n    }()");
    let state = (t10 = hook.createState(), (() => {
      t10[_element] = $this;
      t10[_hook$] = hook;
      t10.initHook();
      return t10;
    ...
    if (!dart.fn(() => {
      $this[_debugIsInitHook$] = false;
      return true;
    }, T$.VoidTobool())()) dart.assertFailed("", I[4], 320, 12, "() {\n      _debugIsInitHook = false;\n      return true;\n    }()");
    return state;
  };
  ...
  framework$['_extension#0|_unmountAllRemainingHooks'] = function _extension$350$124_unmountAllRemainingHooks($this) {
    ...
    if ($this[_currentHookState$] != null) {
      t14 = $this;
      t14[_needDispose$] == null ? t14[_needDispose$] = new (T$.LinkedListOf_EntryOfHookStateOfObjectN$HookOfObjectN()).new() : null;
  ...
  framework$.useContext = function useContext() {
    if (!(framework$.HookElement._currentHookElement != null)) dart.assertFailed("`useContext` can only be called from the build method of HookWidget", I[4], 598, 5, "HookElement._currentHookElement != null");
  ...
  dart.setLibraryUri(hooks._ListenableHook, I[5]);
  ...
  hooks._UseAnimationHook$ = dart.generic(T => {
    ...
    dart.setLibraryUri(_UseAnimationHook, I[5]);
  ...
  hooks._ListenableStateHook = class _ListenableStateHook extends framework$.HookState$(dart.void, hooks._ListenableHook) {
    initHook() {
      let t15;
      super.initHook();
      t15 = this.hook.listenable;
      t15 == null ? null : t15.addListener(dart.bind(this, _listener));
    }
    didUpdateHook(oldHook) {
      let t15, t15$;
      ...
      if (!dart.equals(this.hook.listenable, oldHook.listenable)) {
        t15 = oldHook.listenable;
        t15 == null ? null : t15.removeListener(dart.bind(this, _listener));
        t15$ = this.hook.listenable;
        t15$ == null ? null : t15$.addListener(dart.bind(this, _listener));
      }
    }
  ...
  dart.setLibraryUri(hooks._ListenableStateHook, I[5]);
  hooks._UseAnimationStateHook = class _UseAnimationStateHook extends hooks._ListenableStateHook {
    ...
    get debugValue() {
      let t15;
      t15 = T$.AnimationN().as(this.hook.listenable);
      return t15 == null ? null : t15.value;
    }
    static ['_#new#tearOff']() {
      return new hooks._UseAnimationStateHook.new();
    }
  ...
  dart.setLibraryUri(hooks._UseAnimationStateHook, I[5]);
  ...
  dart.setLibraryUri(hooks._AnimationControllerHook, I[5]);
  ...
  hooks._AnimationControllerHookState = class _AnimationControllerHookState extends framework$.HookState$(animation_controller.AnimationController, hooks._AnimationControllerHook) {
    get [_animationController]() {
      let t16, t15;
      t15 = this[___AnimationControllerHookState__animationController];
      return t15 == null ? (t16 = new animation_controller.AnimationController.new({vsync: this.hook.vsync, duration: this.hook.duration, reverseDuration: this.hook.reverseDuration, debugLabel: this.hook.debugLabel, lowerBound: this.hook.lowerBound, upperBound: this.hook.upperBound, animationBehavior: this.hook.animationBehavior, value: this.hook.initialValue}), this[___AnimationControllerHookState__animationController] == null ? this[___AnimationControllerHookState__animationController] = t16 : dart.throw(new _internal.LateError.fieldADI("_animationController"))) : t15;
    }
    didUpdateHook(oldHook) {
  ...
  dart.setLibraryUri(hooks._AnimationControllerHookState, I[5]);
  ...
  dart.setLibraryUri(hooks._SingleTickerProviderHook, I[5]);
  ...
  dart.setLibraryUri(hooks._TickerProviderHookState, I[5]);
  ...
  hooks._FutureHook$ = dart.generic(T => {
    ...
    dart.setLibraryUri(_FutureHook, I[5]);
  ...
  hooks._FutureStateHook$ = dart.generic(T => {
    ...
    class _FutureStateHook extends framework$.HookState$(async$.AsyncSnapshot$(T), hooks._FutureHook$(T)) {
      get [_snapshot]() {
        let t15;
        t15 = this[___FutureStateHook__snapshot];
        return t15 == null ? this[___FutureStateHook__snapshot] = this.initial : t15;
      }
    ...
    dart.setLibraryUri(_FutureStateHook, I[5]);
  ...
  hooks._StreamHook$ = dart.generic(T => {
    ...
    dart.setLibraryUri(_StreamHook, I[5]);
  ...
  hooks._StreamHookState$ = dart.generic(T => {
    ...
    class _StreamHookState extends framework$.HookState$(async$.AsyncSnapshot$(T), hooks._StreamHook$(T)) {
      get [_summary]() {
        let t15;
        t15 = this[___StreamHookState__summary];
        return t15 == null ? this[___StreamHookState__summary] = this.initial : t15;
      }
    ...
    dart.setLibraryUri(_StreamHookState, I[5]);
  ...
  hooks._StreamControllerHook$ = dart.generic(T => {
    ...
    dart.setLibraryUri(_StreamControllerHook, I[5]);
  ...
  hooks._StreamControllerHookState$ = dart.generic(T => {
    ...
    class _StreamControllerHookState extends framework$.HookState$(async.StreamController$(T), hooks._StreamControllerHook$(T)) {
      get [_controller]() {
        let t16, t15;
        t15 = this[___StreamControllerHookState__controller];
        return t15 == null ? (t16 = __t$StreamControllerOfT().broadcast({sync: this.hook.sync, onCancel: this.hook.onCancel, onListen: this.hook.onListen}), this[___StreamControllerHookState__controller] == null ? this[___StreamControllerHookState__controller] = t16 : dart.throw(new _internal.LateError.fieldADI("_controller"))) : t15;
      }
      didUpdateHook(oldHook) {
    ...
    dart.setLibraryUri(_StreamControllerHookState, I[5]);
  ...
  dart.setLibraryUri(hooks._UseValueListenableHook, I[5]);
  hooks._UseValueListenableStateHook = class _UseValueListenableStateHook extends hooks._ListenableStateHook {
    ...
    get debugValue() {
      let t15;
      t15 = T$.ValueListenableN().as(this.hook.listenable);
      return t15 == null ? null : t15.value;
    }
    static ['_#new#tearOff']() {
      return new hooks._UseValueListenableStateHook.new();
  ...
  dart.setLibraryUri(hooks._UseValueListenableStateHook, I[5]);
  ...
  hooks._ValueNotifierHook$ = dart.generic(T => {
    ...
    dart.setLibraryUri(_ValueNotifierHook, I[5]);
  ...
  hooks._UseValueNotifierHookState$ = dart.generic(T => {
    ...
    class _UseValueNotifierHookState extends framework$.HookState$(change_notifier.ValueNotifier$(T), hooks._ValueNotifierHook$(T)) {
      get notifier() {
        let t16, t15;
        t15 = this[___UseValueNotifierHookState_notifier];
        return t15 == null ? (t16 = new (__t$ValueNotifierOfT()).new(this.hook.initialData), this[___UseValueNotifierHookState_notifier] == null ? this[___UseValueNotifierHookState_notifier] = t16 : dart.throw(new _internal.LateError.fieldADI("notifier"))) : t15;
      }
      build(context) {
    ...
    dart.setLibraryUri(_UseValueNotifierHookState, I[5]);
  ...
  hooks._ReducerHook$ = dart.generic((State, Action) => {
    ...
    dart.setLibraryUri(_ReducerHook, I[5]);
  ...
  hooks._ReducerHookState$ = dart.generic((State, Action) => {
    ...
    class _ReducerHookState extends framework$.HookState$(hooks.Store$(State, Action), hooks._ReducerHook$(State, Action)) {
      get state() {
        ...
        if (!this[___ReducerHookState_state_isSet]) {
          this[___ReducerHookState_state] = (t15 = this.hook, t16 = this.hook.initialState, t17 = this.hook.initialAction, __t$StateAndActionToState().as(t15.reducer)(t16, t17));
          this[___ReducerHookState_state_isSet] = true;
        }
        t15$ = this[___ReducerHookState_state];
        return t15$;
      }
      ...
      dispatch(action) {
        let t17, t16, t15;
        Action.as(action);
        let newState = (t15 = this.hook, t16 = this.state, t17 = action, __t$StateAndActionToState().as(t15.reducer)(t16, t17));
    ...
    dart.setLibraryUri(_ReducerHookState, I[5]);
  ...
  hooks._PreviousHook$ = dart.generic(T => {
    ...
    dart.setLibraryUri(_PreviousHook, I[5]);
  ...
  hooks._PreviousHookState$ = dart.generic(T => {
    ...
    dart.setLibraryUri(_PreviousHookState, I[5]);
  ...
  dart.setLibraryUri(hooks._ReassembleHook, I[5]);
  ...
  dart.setLibraryUri(hooks._ReassembleHookState, I[5]);
  ...
  dart.setLibraryUri(hooks._IsMountedHook, I[5]);
  ...
  dart.setLibraryUri(hooks._IsMountedHookState, I[5]);
  ...
  hooks.ObjectRef$ = dart.generic(T => {
    ...
    dart.setLibraryUri(ObjectRef, I[5]);
  ...
  hooks._MemoizedHook$ = dart.generic(T => {
    ...
    dart.setLibraryUri(_MemoizedHook, I[5]);
  ...
  hooks._MemoizedHookState$ = dart.generic(T => {
    ...
    dart.setLibraryUri(_MemoizedHookState, I[5]);
  ...
  hooks._ValueChangedHook$ = dart.generic((T, R) => {
    ...
    dart.setLibraryUri(_ValueChangedHook, I[5]);
  ...
  hooks._ValueChangedHookState$ = dart.generic((T, R) => {
    ...
    class _ValueChangedHookState extends framework$.HookState$(dart.nullable(R), hooks._ValueChangedHook$(T, R)) {
      didUpdateHook(oldHook) {
        ...
        if (!dart.equals(this.hook.value, oldHook.value)) {
          this[_result] = (t16 = this.hook, t17 = oldHook.value, t18 = this[_result], __t$TAndRNToRN().as(t16.valueChanged)(t17, t18));
        }
      }
      build(context) {
        return this[_result];
    ...
    dart.setLibraryUri(_ValueChangedHookState, I[5]);
  ...
  dart.setLibraryUri(hooks._EffectHook, I[5]);
  ...
  dart.setLibraryUri(hooks._EffectHookState, I[5]);
  ...
  hooks._StateHook$ = dart.generic(T => {
    ...
    dart.setLibraryUri(_StateHook, I[5]);
  ...
  hooks._StateHookState$ = dart.generic(T => {
    ...
    class _StateHookState extends framework$.HookState$(change_notifier.ValueNotifier$(T), hooks._StateHook$(T)) {
      get [_state]() {
        let t17, t17$, t16;
        t16 = this[___StateHookState__state];
        return t16 == null ? (t17$ = (t17 = new (__t$ValueNotifierOfT()).new(this.hook.initialData), (() => {
          t17.addListener(dart.bind(this, _listener));
          return t17;
        })()), this[___StateHookState__state] == null ? this[___StateHookState__state] = t17$ : dart.throw(new _internal.LateError.fieldADI("_state"))) : t16;
      }
      dispose() {
        this[_state].dispose();
      }
    ...
    dart.setLibraryUri(_StateHookState, I[5]);
  ...
  dart.setLibraryUri(hooks._TabControllerHook, I[5]);
  ...
  hooks._TabControllerHookState = class _TabControllerHookState extends framework$.HookState$(tab_controller.TabController, hooks._TabControllerHook) {
    get controller() {
      let t17, t16;
      t16 = this[___TabControllerHookState_controller];
      return t16 == null ? (t17 = new tab_controller.TabController.new({length: this.hook.length, initialIndex: this.hook.initialIndex, vsync: this.hook.vsync}), this[___TabControllerHookState_controller] == null ? this[___TabControllerHookState_controller] = t17 : dart.throw(new _internal.LateError.fieldADI("controller"))) : t16;
    }
    build(context) {
  ...
  dart.setLibraryUri(hooks._TabControllerHookState, I[5]);
  ...
  dart.setLibraryUri(hooks._TextEditingControllerHookCreator, I[5]);
  ...
  dart.setLibraryUri(hooks._TextEditingControllerHook, I[5]);
  ...
  hooks._TextEditingControllerHookState = class _TextEditingControllerHookState extends framework$.HookState$(editable_text.TextEditingController, hooks._TextEditingControllerHook) {
    get [_controller]() {
      let t17, t16;
      t16 = this[___TextEditingControllerHookState__controller];
      return t16 == null ? (t17 = this.hook.initialValue != null ? new editable_text.TextEditingController.fromValue(this.hook.initialValue) : new editable_text.TextEditingController.new({text: this.hook.initialText}), this[___TextEditingControllerHookState__controller] == null ? this[___TextEditingControllerHookState__controller] = t17 : dart.throw(new _internal.LateError.fieldADI("_controller"))) : t16;
    }
    build(context) {
      return this[_controller];
    }
  ...
  dart.setLibraryUri(hooks._TextEditingControllerHookState, I[5]);
  ...
  dart.setLibraryUri(hooks._FocusNodeHook, I[5]);
  ...
  hooks._FocusNodeHookState = class _FocusNodeHookState extends framework$.HookState$(focus_manager.FocusNode, hooks._FocusNodeHook) {
    get [_focusNode]() {
      let t17, t16;
      t16 = this[___FocusNodeHookState__focusNode];
      return t16 == null ? (t17 = new focus_manager.FocusNode.new({debugLabel: this.hook.debugLabel, onKey: this.hook.onKey, onKeyEvent: this.hook.onKeyEvent, skipTraversal: this.hook.skipTraversal, canRequestFocus: this.hook.canRequestFocus, descendantsAreFocusable: this.hook.descendantsAreFocusable}), this[___FocusNodeHookState__focusNode] == null ? this[___FocusNodeHookState__focusNode] = t17 : dart.throw(new _internal.LateError.fieldADI("_focusNode"))) : t16;
    }
    didUpdateHook(oldHook) {
      let t16;
      ...
      t16 = this[_focusNode];
      (() => {
        t16.debugLabel = this.hook.debugLabel;
        t16.skipTraversal = this.hook.skipTraversal;
        t16.canRequestFocus = this.hook.canRequestFocus;
        t16.descendantsAreFocusable = this.hook.descendantsAreFocusable;
        t16.onKey = this.hook.onKey;
        t16.onKeyEvent = this.hook.onKeyEvent;
        return t16;
      })();
    }
    build(context) {
  ...
  dart.setLibraryUri(hooks._FocusNodeHookState, I[5]);
  ...
  dart.setLibraryUri(hooks._FocusScopeNodeHook, I[5]);
  ...
  dart.setLibraryUri(hooks._FocusScopeNodeHookState, I[5]);
  ...
  dart.setLibraryUri(hooks._ScrollControllerHook, I[5]);
  ...
  hooks._ScrollControllerHookState = class _ScrollControllerHookState extends framework$.HookState$(scroll_controller.ScrollController, hooks._ScrollControllerHook) {
    get controller() {
      let t17, t16;
      t16 = this[___ScrollControllerHookState_controller];
      return t16 == null ? (t17 = new scroll_controller.ScrollController.new({initialScrollOffset: this.hook.initialScrollOffset, keepScrollOffset: this.hook.keepScrollOffset, debugLabel: this.hook.debugLabel}), this[___ScrollControllerHookState_controller] == null ? this[___ScrollControllerHookState_controller] = t17 : dart.throw(new _internal.LateError.fieldADI("controller"))) : t16;
    }
    build(context) {
      return this.controller;
    }
  ...
  dart.setLibraryUri(hooks._ScrollControllerHookState, I[5]);
  ...
  dart.setLibraryUri(hooks._PageControllerHook, I[5]);
  ...
  hooks._PageControllerHookState = class _PageControllerHookState extends framework$.HookState$(page_view.PageController, hooks._PageControllerHook) {
    get controller() {
      let t17, t16;
      t16 = this[___PageControllerHookState_controller];
      return t16 == null ? (t17 = new page_view.PageController.new({initialPage: this.hook.initialPage, keepPage: this.hook.keepPage, viewportFraction: this.hook.viewportFraction}), this[___PageControllerHookState_controller] == null ? this[___PageControllerHookState_controller] = t17 : dart.throw(new _internal.LateError.fieldADI("controller"))) : t16;
    }
    build(context) {
      return this.controller;
    }
  ...
  dart.setLibraryUri(hooks._PageControllerHookState, I[5]);
  ...
  dart.setLibraryUri(hooks._AppLifecycleHook, I[5]);
  ...
  hooks.__AppLifecycleStateState = class __AppLifecycleStateState extends HookState_WidgetsBindingObserver$36 {
    ...
    didChangeAppLifecycleState(state) {
      ...
      this[_state] = state;
      t16 = this.hook.onStateChanged;
      t16 == null ? null : t16(previous, state);
  ...
  dart.setLibraryUri(hooks.__AppLifecycleStateState, I[5]);
  ...
  dart.setLibraryUri(hooks._TransformationControllerHook, I[5]);
  ...
  hooks._TransformationControllerHookState = class _TransformationControllerHookState extends framework$.HookState$(interactive_viewer.TransformationController, hooks._TransformationControllerHook) {
    get controller() {
      let t17, t16;
      t16 = this[___TransformationControllerHookState_controller];
      return t16 == null ? (t17 = new interactive_viewer.TransformationController.new(this.hook.initialValue), this[___TransformationControllerHookState_controller] == null ? this[___TransformationControllerHookState_controller] = t17 : dart.throw(new _internal.LateError.fieldADI("controller"))) : t16;
    }
    build(context) {
      return this.controller;
    }
  ...
  dart.setLibraryUri(hooks._TransformationControllerHookState, I[5]);
  ...
  dart.setLibraryUri(hooks._PlatformBrightnessHook, I[5]);
  ...
  hooks._PlatformBrightnessState = class _PlatformBrightnessState extends HookState_WidgetsBindingObserver$36$ {
    get [_brightness]() {
      let t16;
      t16 = this[___PlatformBrightnessState__brightness];
      return t16 == null ? dart.throw(new _internal.LateError.fieldNI("_brightness")) : t16;
    }
    ...
    didChangePlatformBrightness() {
      ...
      this[_brightness] = binding.WidgetsBinding.instance.window.platformBrightness;
      t16 = this.hook.onBrightnessChange;
      t16 == null ? null : t16(_previous, this[_brightness]);
      if (this.hook.rebuildOnChange) {
        this.setState(dart.fn(() => {
        }, T$.VoidTovoid()));
      }
  ...
  dart.setLibraryUri(hooks._PlatformBrightnessState, I[5]);
  ...
  dart.setLibraryUri(hooks._AutomaticKeepAliveHook, I[5]);
  ...
  dart.setLibraryUri(hooks._AutomaticKeepAliveHookState, I[5]);
  ...
  hooks._ListenableSelectorHook$ = dart.generic(R => {
    ...
    dart.setLibraryUri(_ListenableSelectorHook, I[5]);
  ...
  hooks._ListenableSelectorHookState$ = dart.generic(R => {
    ...
    class _ListenableSelectorHookState extends framework$.HookState$(R, hooks._ListenableSelectorHook$(R)) {
      get [_selectorResult]() {
        ...
        t16 = this[___ListenableSelectorHookState__selectorResult];
        return t16;
      }
    ...
    dart.setLibraryUri(_ListenableSelectorHookState, I[5]);
  ...
  hooks.useReassemble = function useReassemble(callback) {
    if (!dart.fn(() => {
      ...
      return true;
    }, T$.VoidTobool())()) dart.assertFailed("", I[7], 139, 10, "() {\n    use(_ReassembleHook(callback));\n    return true;\n  }()");
  };
  ...
  dart.setLibraryUri(ordenador.Decididor, I[8]);
  ordenador.Ordenador = class Ordenador extends core.Object {
    ordenadorCarinhoso(item, callback, crescente) {
      let itemOrdenados = core.List.of(item);
      let trocouAoMenosUm = null;
      do {
        trocouAoMenosUm = false;
        for (let i = 0; i < itemOrdenados[$length] - 1; i = i + 1) {
          let atual = itemOrdenados[$_get](i);
          let proximo = itemOrdenados[$_get](i + 1);
          if (callback(atual, proximo, crescente)) {
            let aux = itemOrdenados[$_get](i);
            itemOrdenados[$_set](i, itemOrdenados[$_get](i + 1));
            itemOrdenados[$_set](i + 1, aux);
    ...
    ssOrdenar(item, funcaoCall) {
      let itemOrdenadas = core.List.of(item);
      let trocouAoMenosUm = null;
      let funcao = funcaoCall;
      do {
        trocouAoMenosUm = false;
        for (let i = 0; i < itemOrdenadas[$length] - 1; i = i + 1) {
          let atual = itemOrdenadas[$_get](i);
          let proximo = itemOrdenadas[$_get](i + 1);
          if (dart.dtest(dart.dcall(funcao, [atual, proximo]))) {
            let aux = itemOrdenadas[$_get](i);
            itemOrdenadas[$_set](i, itemOrdenadas[$_get](i + 1));
            itemOrdenadas[$_set](i + 1, aux);
            trocouAoMenosUm = true;
          }
        }
      } while (trocouAoMenosUm);
  ...
  dart.setMethodSignature(ordenador.Ordenador, () => ({
    ...
    ordenadorCarinhoso: dart.fnType(core.List, [core.List, dart.fnType(core.bool, [dart.dynamic, dart.dynamic, core.bool]), core.bool]),
    ssOrdenar: dart.fnType(core.List, [core.List, core.Function])
  }));
  dart.setLibraryUri(ordenador.Ordenador, I[8]);
  filtrador.Filtrador = class Filtrador extends core.Object {
    filtrar(objetos, filtro, callbackDecididor) {
      let objetosFiltrados = [];
      for (let i = 0; i < objetos[$length]; i = i + 1) {
        if (dart.dtest(dart.dcall(callbackDecididor, [objetos[$_get](i), filtro]))) {
          objetosFiltrados[$add](objetos[$_get](i));
        }
      }
      return objetosFiltrados;
    }
    static ['_#new#tearOff']() {
      return new filtrador.Filtrador.new();
    }
  };
  (filtrador.Filtrador.new = function() {
    ;
  }).prototype = filtrador.Filtrador.prototype;
  dart.addTypeTests(filtrador.Filtrador);
  dart.addTypeCaches(filtrador.Filtrador);
  dart.setMethodSignature(filtrador.Filtrador, () => ({
    __proto__: dart.getMethods(filtrador.Filtrador.__proto__),
    filtrar: dart.fnType(core.List, [core.List, core.String, core.Function])
  }));
  dart.setLibraryUri(filtrador.Filtrador, I[3]);
  client$.Client = class Client extends core.Object {
    static new() {
      let t16;
      t16 = client$.zoneClient;
      return t16 == null ? browser_client.createClient() : t16;
    }
    static ['_#new#tearOff']() {
  ...
  dart.setLibraryUri(client$.Client, I[9]);
  ...
  dart.setLibraryUri(exception.ClientException, I[10]);
  ...
  dart.setLibraryUri(base_request.BaseRequest, I[11]);
  ...
  dart.setLibraryUri(request$.Request, I[12]);
  ...
  dart.setLibraryUri(base_response.BaseResponse, I[13]);
  ...
  dart.setLibraryUri(streamed_request.StreamedRequest, I[15]);
  ...
  dart.setLibraryUri(base_client.BaseClient, I[16]);
  ...
  dart.setLibraryUri(byte_stream.ByteStream, I[17]);
  ...
  (multipart_file.MultipartFile.new = function(field, stream, length, opts) {
    ...
    this[contentType$] = (t17 = contentType, t17 == null ? new media_type.MediaType.new("application", "octet-stream") : t17);
    ;
  ...
  dart.setLibraryUri(multipart_file.MultipartFile, I[18]);
  ...
  dart.setLibraryUri(multipart_request.MultipartRequest, I[19]);
  ...
  browser_client.BrowserClient = class BrowserClient extends base_client.BaseClient {
    ...
    send(request) {
      return async.async(streamed_response.StreamedResponse, (function* send() {
        ...
        t17 = xhr;
        (() => {
          t17.open(request.method, dart.str(request.url), {async: true});
          t17[$responseType] = "arraybuffer";
          t17.withCredentials = this.withCredentials;
          return t17;
        })();
  ...
  dart.setLibraryUri(browser_client.BrowserClient, I[21]);
  ...
  utils.mapToQuery = function mapToQuery(map, opts) {
    ...
    map[$forEach](dart.fn((key, value) => {
      let t17, t17$;
      return pairs[$add](T$.JSArrayOfString().of([core.Uri.encodeQueryComponent(key, {encoding: (t17 = encoding, t17 == null ? convert.utf8 : t17)}), core.Uri.encodeQueryComponent(value, {encoding: (t17$ = encoding, t17$ == null ? convert.utf8 : t17$)})]));
    }, T$.StringAndStringTovoid()));
  ...
  utils.encodingForCharset = function encodingForCharset(charset, fallback = C[38] || CT.C38) {
    ...
    t17 = convert.Encoding.getByName(charset);
    return t17 == null ? fallback : t17;
  };
  utils.requiredEncodingForCharset = function requiredEncodingForCharset(charset) {
    let t17;
    t17 = convert.Encoding.getByName(charset);
    return t17 == null ? dart.throw(new core.FormatException.new("Unsupported encoding \"" + charset + "\".")) : t17;
  };
  ...
  dart.setLibraryUri(authentication_challenge.AuthenticationChallenge, I[22]);
  ...
  case_insensitive_map.CaseInsensitiveMap$ = dart.generic(V => {
    ...
    dart.setLibraryUri(CaseInsensitiveMap, I[23]);
  ...
  dart.setLibraryUri(chunked_coding.ChunkedCodingCodec, I[24]);
  ...
  http_date.formatHttpDate = function formatHttpDate(date) {
    let t17;
    date = date.toUtc();
    let buffer = (t17 = new core.StringBuffer.new(), (() => {
      t17.write(http_date._weekdays[$_get](date.weekday - 1));
      t17.write(", ");
      t17.write(date.day <= 9 ? "0" : "");
      t17.write(date.day[$toString]());
      t17.write(" ");
      t17.write(http_date._months[$_get](date.month - 1));
      t17.write(" ");
      t17.write(date.year[$toString]());
      t17.write(date.hour <= 9 ? " 0" : " ");
      t17.write(date.hour[$toString]());
      t17.write(date.minute <= 9 ? ":0" : ":");
      t17.write(date.minute[$toString]());
      t17.write(date.second <= 9 ? ":0" : ":");
      t17.write(date.second[$toString]());
      t17.write(" GMT");
      return t17;
    })());
    ...
    toString() {
      ...
      this.parameters[$forEach](dart.fn((attribute, value) => {
        ...
        if (scan.nonToken.hasMatch(value)) {
          ...
          (() => {
            t17.write("\"");
            t17.write(value[$replaceAllMapped](media_type._escapedChar, dart.fn(match => "\\" + dart.str(match._get(0)), T$.MatchToString())));
            t17.write("\"");
            return t17;
          })();
        } else {
  ...
  dart.setLibraryUri(media_type.MediaType, I[25]);
  ...
  dart.setLibraryUri(decoder.ChunkedCodingDecoder, I[26]);
  ...
  dart.setLibraryUri(decoder._Sink, I[26]);
  ...
  dart.setLibraryUri(decoder._State, I[26]);
  ...
  dart.setLibraryUri(encoder.ChunkedCodingEncoder, I[27]);
  ...
  dart.setLibraryUri(encoder._Sink, I[27]);
  ...
  typed_queue._TypedQueue$ = dart.generic((E, L) => {
    ...
    class _TypedQueue extends Object_ListMixin$36 {
      ...
      [_writeToList](target, start = null, end = null) {
        ...
        if (!(target[$length] >= dart.notNull(end) - dart.notNull(start))) dart.assertFailed(null, I[28], 278, 12, "target.length >= end - start");
        if (!(dart.notNull(start) <= dart.notNull(end))) dart.assertFailed(null, I[28], 279, 12, "start <= end");
      ...
      [_growAtCapacity]() {
        if (!(this[_head$] === this[_tail$])) dart.assertFailed(null, I[28], 297, 12, "_head == _tail");
      ...
      [_growTo](newElementCount) {
        if (!(newElementCount >= this.length)) dart.assertFailed(null, I[28], 316, 12, "newElementCount >= length");
    ...
    dart.setLibraryUri(_TypedQueue, I[29]);
  ...
  typed_queue._IntQueue$ = dart.generic(L => {
    ...
    dart.setLibraryUri(_IntQueue, I[29]);
    return _IntQueue;
  });
  ...
  typed_queue._FloatQueue$ = dart.generic(L => {
    ...
    dart.setLibraryUri(_FloatQueue, I[29]);
    return _FloatQueue;
  });
  ...
  dart.setLibraryUri(typed_queue.Uint8Queue, I[29]);
  ...
  dart.setLibraryUri(typed_queue.Int8Queue, I[29]);
  ...
  dart.setLibraryUri(typed_queue.Uint8ClampedQueue, I[29]);
  ...
  dart.setLibraryUri(typed_queue.Uint16Queue, I[29]);
  ...
  dart.setLibraryUri(typed_queue.Int16Queue, I[29]);
  ...
  dart.setLibraryUri(typed_queue.Uint32Queue, I[29]);
  ...
  dart.setLibraryUri(typed_queue.Int32Queue, I[29]);
  ...
  dart.setLibraryUri(typed_queue.Uint64Queue, I[29]);
  ...
  dart.setLibraryUri(typed_queue.Int64Queue, I[29]);
  ...
  dart.setLibraryUri(typed_queue.Float32Queue, I[29]);
  ...
  dart.setLibraryUri(typed_queue.Float64Queue, I[29]);
  ...
  dart.setLibraryUri(typed_queue.Int32x4Queue, I[29]);
  ...
  dart.setLibraryUri(typed_queue.Float32x4Queue, I[29]);
  ...
  typed_queue._nextPowerOf2 = function _nextPowerOf2(number) {
    if (!(number > 0)) dart.assertFailed(null, I[28], 691, 10, "number > 0");
    number = (number << 1 >>> 0) - 1;
    for (;;) {
  ...
  typed_buffer.TypedDataBuffer$ = dart.generic(E => {
    ...
    dart.setLibraryUri(TypedDataBuffer, I[30]);
  ...
  dart.setLibraryUri(typed_buffer._IntBuffer, I[30]);
  ...
  dart.setLibraryUri(typed_buffer._FloatBuffer, I[30]);
  ...
  dart.setLibraryUri(typed_buffer.Uint8Buffer, I[30]);
  ...
  dart.setLibraryUri(typed_buffer.Int8Buffer, I[30]);
  ...
  dart.setLibraryUri(typed_buffer.Uint8ClampedBuffer, I[30]);
  ...
  dart.setLibraryUri(typed_buffer.Uint16Buffer, I[30]);
  ...
  dart.setLibraryUri(typed_buffer.Int16Buffer, I[30]);
  ...
  dart.setLibraryUri(typed_buffer.Uint32Buffer, I[30]);
  ...
  dart.setLibraryUri(typed_buffer.Int32Buffer, I[30]);
  ...
  dart.setLibraryUri(typed_buffer.Uint64Buffer, I[30]);
  ...
  dart.setLibraryUri(typed_buffer.Int64Buffer, I[30]);
  ...
  dart.setLibraryUri(typed_buffer.Float32Buffer, I[30]);
  ...
  dart.setLibraryUri(typed_buffer.Float64Buffer, I[30]);
  ...
  dart.setLibraryUri(typed_buffer.Int32x4Buffer, I[30]);
  ...
  dart.setLibraryUri(typed_buffer.Float32x4Buffer, I[30]);
  dart.trackLibraries("zapp_user_main", {
    ...
    "file:///zapp/project/lib/util/filtrador.dart": filtrador,
  ...
  return {
    ...
    zapp__project__lib__util__filtrador: filtrador,
    src__client: client$,
