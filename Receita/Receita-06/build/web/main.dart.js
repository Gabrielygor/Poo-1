...
define('zapp_user_main', ['dart_sdk', 'flutter_sdk'], (function load__zapp_user_main(dart_sdk, flutter_sdk) {
  ...
  dart.defineLazy(CT, {
    ...
    get C13() {
      return C[13] = dart.constList(["Nome", "Estilo", "IBU"], core.String);
    },
    get C14() {
      return C[14] = dart.constList(["name", "style", "ibu"], core.String);
    },
    get C15() {
    ...
    get C19() {
      return C[19] = dart.constList([], core.Object);
    },
    get C20() {
  ...
  main.DataService = class DataService extends core.Object {
    ...
    carregarCervejas() {
      this.defCerveja();
      this.tableStateNotifier.value = [new (T$.IdentityMapOfString$String()).from(["name", "La Fin Du Monde", "style", "Bock", "ibu", "65"]), new (T$.IdentityMapOfString$String()).from(["name", "Sapporo Premiume", "style", "Sour Ale", "ibu", "54"]), new (T$.IdentityMapOfString$String()).from(["name", "Duvel", "style", "Pilsner", "ibu", "82"])];
    }
    carregarCafe() {
      this.chaves = T$.JSArrayOfString().of(["name", "tipo", "sab"]);
      this.colunas = T$.JSArrayOfString().of(["Nome", "Tipo", "Sabor"]);
      this.tableStateNotifier.value = [new (T$.IdentityMapOfString$String()).from(["name", "Café Acaiá", "tipo", "gelado", "sab", "XXXXX"]), new (T$.IdentityMapOfString$String()).from(["name", "Café Robusta", "tipo", "quente", "sab", "XXXXX"]), new (T$.IdentityMapOfString$String()).from(["name", "Café Kona", "tipo", "quente", "sab", "XXXXX"])];
    }
    carregarNacoes() {
      this.chaves = T$.JSArrayOfString().of(["name", "moeda", "hab"]);
      this.colunas = T$.JSArrayOfString().of(["Nome", "Moeda", "Habitantes"]);
      this.tableStateNotifier.value = [new (T$.IdentityMapOfString$String()).from(["name", "Brasil", "moeda", "Real", "hab", "Muitos"]), new (T$.IdentityMapOfString$String()).from(["name", "Eslováquia", "moeda", "Euros", "hab", "Alguns"]), new (T$.IdentityMapOfString$String()).from(["name", "China", "moeda", "Yuan chinês", "hab", "Pra KRLH"])];
    }
  ...
  dart.setMethodSignature(main.DataService, () => ({
    ...
    defCerveja: dart.fnType(dart.void, []),
  ...
  main.NewNavBar = class NewNavBar extends framework$.HookWidget {
    ...
    build(context) {
      ...
      return new bottom_navigation_bar.BottomNavigationBar.new({onTap: dart.fn(index => {
        ...
        }, T$.intTovoid()), currentIndex: state.value, items: C[2] || CT.C2});
    }
  };
  ...
  main.DataTableWidget = class DataTableWidget extends framework.StatelessWidget {
    ...
    static ['_#new#tearOff'](opts) {
      let jsonObjects = opts && 'jsonObjects' in opts ? opts.jsonObjects : C[12] || CT.C12;
      let columnNames = opts && 'columnNames' in opts ? opts.columnNames : C[13] || CT.C13;
  ...
  hooks.useAnimationController = function useAnimationController(opts) {
    ...
    let vsync = opts && 'vsync' in opts ? opts.vsync : null;
    let animationBehavior = opts && 'animationBehavior' in opts ? opts.animationBehavior : C[15] || CT.C15;
    let keys = opts && 'keys' in opts ? opts.keys : null;
  ...
  hooks.useSingleTickerProvider = function useSingleTickerProvider(opts) {
    let keys = opts && 'keys' in opts ? opts.keys : null;
    return framework$.use(ticker.TickerProvider, keys != null ? new hooks._SingleTickerProviderHook.new(keys) : C[16] || CT.C16);
  };
  ...
  hooks.useIsMounted = function useIsMounted() {
    return framework$.use(T$.VoidTobool(), C[17] || CT.C17);
  };
  ...
  hooks.usePlatformBrightness = function usePlatformBrightness() {
    return framework$.use(ui.Brightness, C[18] || CT.C18);
  };
  ...
  hooks.useMemoized = function useMemoized(T, valueBuilder, keys = C[19] || CT.C19) {
  ...
  hooks.useAppLifecycleState = function useAppLifecycleState() {
    return framework$.use(T$.AppLifecycleStateN(), C[20] || CT.C20);
  };
