...
define('zapp_user_main', ['dart_sdk', 'flutter_sdk'], (function load__zapp_user_main(dart_sdk, flutter_sdk) {
  ...
  dart.defineLazy(CT, {
    ...
    get C4() {
      return C[4] = dart.const({
        ...
        [BottomNavigationBarItem_label]: "Coofe",
    ...
    get C13() {
      return C[13] = dart.constList([C[4] || CT.C4, C[7] || CT.C7, C[14] || CT.C14], bottom_navigation_bar_item.BottomNavigationBarItem);
    },
    get C15() {
  ...
  main.DataTableWidget = class DataTableWidget extends framework.StatelessWidget {
    ...
    build(context) {
      core.print("tap on DataTableWidget");
      let columnNames = T$.JSArrayOfString().of(["xxxx", "xxxxxx", "xxx"]);
      let propertyNames = T$.JSArrayOfString().of(["xxxx", "xxxxxx", "xxx"]);
  ...
  main.NewNavBar2 = class NewNavBar2 extends framework.StatefulWidget {
    createState() {
      return new main._NewNavBar2State.new();
    }
    static ['_#new#tearOff']() {
      return new main.NewNavBar2.new();
    }
  };
  (main.NewNavBar2.new = function() {
    main.NewNavBar2.__proto__.new.call(this);
    ;
  }).prototype = main.NewNavBar2.prototype;
  dart.addTypeTests(main.NewNavBar2);
  dart.addTypeCaches(main.NewNavBar2);
  dart.setMethodSignature(main.NewNavBar2, () => ({
    __proto__: dart.getMethods(main.NewNavBar2.__proto__),
    createState: dart.fnType(main._NewNavBar2State, [])
  }));
  dart.setLibraryUri(main.NewNavBar2, I[0]);
  ...
  main._NewNavBar2State = class _NewNavBar2State extends framework.State$(main.NewNavBar2) {
    build(context) {
      core.print("tap on NewNavBar2");
      return new bottom_navigation_bar.BottomNavigationBar.new({onTap: dart.fn(index => {
          this.setState(dart.fn(() => {
            this[_selectedIndex] = index;
          }, T$.VoidTovoid()));
        }, T$.intTovoid()), currentIndex: this[_selectedIndex], items: C[3] || CT.C3});
    }
    static ['_#new#tearOff']() {
      return new main._NewNavBar2State.new();
    }
  };
  (main._NewNavBar2State.new = function() {
    this[_selectedIndex] = 1;
    main._NewNavBar2State.__proto__.new.call(this);
    ;
  }).prototype = main._NewNavBar2State.prototype;
  dart.addTypeTests(main._NewNavBar2State);
  dart.addTypeCaches(main._NewNavBar2State);
  dart.setMethodSignature(main._NewNavBar2State, () => ({
    __proto__: dart.getMethods(main._NewNavBar2State.__proto__),
    build: dart.fnType(framework.Widget, [framework.BuildContext])
  }));
  dart.setLibraryUri(main._NewNavBar2State, I[0]);
  dart.setFieldSignature(main._NewNavBar2State, () => ({
    __proto__: dart.getFields(main._NewNavBar2State.__proto__),
  ...
  main.NewNavBar = class NewNavBar extends framework$.HookWidget {
    ...
    build(context) {
      core.print("in build of NewNavBar");
      let state = hooks.useState(core.int, 1);
      return new bottom_navigation_bar.BottomNavigationBar.new({onTap: dart.fn(index => {
          state.value = index;
        }, T$.intTovoid()), currentIndex: state.value, items: C[13] || CT.C13});
    }
  };
