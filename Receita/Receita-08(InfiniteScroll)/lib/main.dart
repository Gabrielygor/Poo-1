...
/* Receita 8 infinite Scroll

Video usado para ajudar a desenvolver o codigo
https://www.youtube.com/watch?v=sMKczu6Gqy4&ab_channel=CodeDrops

OBS: Cuidado com o contador de itens totais expostos 
          ...
          builder: (_, value, __) {
            switch (value['status']) {
              case TableStatus.idle:
                return Center(child: Text("1.Toque em um dos botoes abaixo"));
              ...
              case TableStatus.error:
                return Text("Erro ao carregar a lista");
            }
            return Text("...");
          },
        ),
...
class ListWidget extends HookWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Column(
      children: [
        Text('Total de Itens Carregados: $displayedItemCount'),
        Expanded(
