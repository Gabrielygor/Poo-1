...
define('zapp_user_main', ['dart_sdk', 'flutter_sdk'], (function load__zapp_user_main(dart_sdk, flutter_sdk) {
  ...
  var T$ = {
    ...
    LinkedMapOfItemType$VoidTovoid: () => (T$.LinkedMapOfItemType$VoidTovoid = dart.constFn(_js_helper.LinkedMap$(main.ItemType, T$.VoidTovoid())))(),
  ...
  dart.defineLazy(CT, {
    ...
    get C2() {
      return C[2] = dart.const({
        __proto__: main.TableStatus.prototype,
        [_Enum__name]: "idle",
        [_Enum_index]: 0
      });
    },
    ...
    get C1() {
      return C[1] = dart.constList([C[2] || CT.C2, C[3] || CT.C3, C[4] || CT.C4, C[5] || CT.C5], main.TableStatus);
    },
    get C7() {
      return C[7] = dart.const({
        __proto__: main.ItemType.prototype,
        [_Enum__name]: "beer",
        [_Enum_index]: 0
      });
    },
    ...
    get C6() {
      return C[6] = dart.constList([C[7] || CT.C7, C[8] || CT.C8, C[9] || CT.C9, C[10] || CT.C10], main.ItemType);
    },
    get C14() {
    ...
    get C12() {
      return C[12] = dart.const({
        ...
        [BottomNavigationBarItem_label]: "Beer",
    ...
    get C15() {
      return C[15] = dart.const({
        ...
        [BottomNavigationBarItem_tooltip]: null,
        [BottomNavigationBarItem_backgroundColor]: null,
        [BottomNavigationBarItem_label]: "Coffee",
    ...
    get C18() {
      return C[18] = dart.const({
        ...
        [BottomNavigationBarItem_tooltip]: null,
        [BottomNavigationBarItem_backgroundColor]: null,
        [BottomNavigationBarItem_label]: "Nations",
    ...
    get C21() {
      return C[21] = dart.constList([], dart.dynamic);
    },
    get C22() {
      return C[22] = dart.constList(["name", "style", "ibu"], core.String);
    },
    get C23() {
  ...
  main.TableStatus = class TableStatus extends core._Enum {
    [_enumToString]() {
      return "TableStatus." + this[_name];
    }
  };
  (main.TableStatus.new = function(index, name) {
    main.TableStatus.__proto__.new.call(this, index, name);
    ;
  }).prototype = main.TableStatus.prototype;
  dart.addTypeTests(main.TableStatus);
  dart.addTypeCaches(main.TableStatus);
  dart.setMethodSignature(main.TableStatus, () => ({
    __proto__: dart.getMethods(main.TableStatus.__proto__),
    [_enumToString]: dart.fnType(core.String, [])
  }));
  dart.setLibraryUri(main.TableStatus, I[0]);
  dart.setStaticFieldSignature(main.TableStatus, () => ['values', 'idle', 'loading', 'ready', 'error']);
  dart.defineLazy(main.TableStatus, {
    /*main.TableStatus.values*/get values() {
      return C[1] || CT.C1;
    },
    /*main.TableStatus.idle*/get idle() {
      return C[2] || CT.C2;
    },
    /*main.TableStatus.loading*/get loading() {
      return C[3] || CT.C3;
    },
    /*main.TableStatus.ready*/get ready() {
      return C[4] || CT.C4;
    },
    /*main.TableStatus.error*/get error() {
      return C[5] || CT.C5;
    }
  }, false);
  main.ItemType = class ItemType extends core._Enum {
    [_enumToString]() {
      return "ItemType." + this[_name];
    }
  };
  (main.ItemType.new = function(index, name) {
    main.ItemType.__proto__.new.call(this, index, name);
    ;
  }).prototype = main.ItemType.prototype;
  dart.addTypeTests(main.ItemType);
  dart.addTypeCaches(main.ItemType);
  dart.setMethodSignature(main.ItemType, () => ({
    __proto__: dart.getMethods(main.ItemType.__proto__),
    [_enumToString]: dart.fnType(core.String, [])
  }));
  dart.setLibraryUri(main.ItemType, I[0]);
  dart.setStaticFieldSignature(main.ItemType, () => ['values', 'beer', 'coffee', 'nation', 'none']);
  dart.defineLazy(main.ItemType, {
    /*main.ItemType.values*/get values() {
      return C[6] || CT.C6;
    },
    /*main.ItemType.beer*/get beer() {
      return C[7] || CT.C7;
    },
    /*main.ItemType.coffee*/get coffee() {
      return C[8] || CT.C8;
    },
    /*main.ItemType.nation*/get nation() {
      return C[9] || CT.C9;
    },
    /*main.ItemType.none*/get none() {
      return C[10] || CT.C10;
    }
  }, false);
  ...
  main.DataService = class DataService extends core.Object {
    ...
    loadData(uri, itemType, propertyNames) {
      if (dart.equals(this.tableStateNotifier.value[$_get]("status"), main.TableStatus.loading)) return;
      if (!dart.equals(this.tableStateNotifier.value[$_get]("itemType"), itemType)) {
        this.tableStateNotifier.value = new (T$.IdentityMapOfString$dynamic()).from(["status", main.TableStatus.loading, "dataObjects", [], "itemType", itemType]);
      }
      http.read(uri).then(core.Null, dart.fn(jsonString => {
        let jsonData = convert.jsonDecode(jsonString);
        if (!dart.equals(this.tableStateNotifier.value[$_get]("status"), main.TableStatus.loading)) {
          jsonData = (() => {
            let t4 = core.List.of(core.Iterable.as(this.tableStateNotifier.value[$_get]("dataObjects")));
            t4[$addAll](core.Iterable.as(jsonData));
            return t4;
          })();
        }
        this.tableStateNotifier.value = new (T$.IdentityMapOfString$dynamic()).from(["itemType", itemType, "status", main.TableStatus.ready, "dataObjects", jsonData, "propertyNames", propertyNames, "columnNames", (() => {
            let t5 = T$.JSArrayOfString().of(["Nome"]);
            t5[$addAll](propertyNames);
            return t5;
          })()]);
      }, T$.StringToNull()));
    }
    ...
    carregarCafes() {
      let coffeesUri = core._Uri.new({scheme: "https", host: "random-data-api.com", path: "api/coffee/random_coffee", queryParameters: new (T$.IdentityMapOfString$dynamic()).from(["size", "10"])});
      this.loadData(coffeesUri, main.ItemType.coffee, T$.JSArrayOfString().of(["blend_name", "origin", "variety"]));
    }
    carregarNacoes() {
      let nationsUri = core._Uri.new({scheme: "https", host: "random-data-api.com", path: "api/nation/random_nation", queryParameters: new (T$.IdentityMapOfString$dynamic()).from(["size", "10"])});
      this.loadData(nationsUri, main.ItemType.nation, T$.JSArrayOfString().of(["nationality", "capital", "language", "national_sport"]));
    }
    carregarCervejas() {
      let beersUri = core._Uri.new({scheme: "https", host: "random-data-api.com", path: "api/beer/random_beer", queryParameters: new (T$.IdentityMapOfString$dynamic()).from(["size", "10"])});
      this.loadData(beersUri, main.ItemType.beer, T$.JSArrayOfString().of(["name", "style", "ibu"]));
    }
  ...
  (main.DataService.new = function() {
    this[tableStateNotifier] = new (T$.ValueNotifierOfMapOfString$dynamic()).new(new (T$.IdentityMapOfString$dynamic()).from(["status", main.TableStatus.idle, "dataObjects", []]));
    ;
  ...
  dart.setMethodSignature(main.DataService, () => ({
    ...
    loadData: dart.fnType(dart.void, [core.Uri, main.ItemType, core.List$(core.String)]),
    carregar: dart.fnType(dart.void, [main.ItemType]),
  ...
  var functionsMap = dart.privateName(main, "MyApp.functionsMap");
  main.MyApp = class MyApp extends framework.StatelessWidget {
    get functionsMap() {
      return this[functionsMap];
    }
    set functionsMap(value) {
      super.functionsMap = value;
    }
    build(context) {
      return new app.MaterialApp.new({theme: theme_data.ThemeData.new({primarySwatch: colors.Colors.lightBlue}), debugShowCheckedModeBanner: false, home: new scaffold.Scaffold.new({appBar: new app_bar.AppBar.new({title: new text.Text.new("Infinite Scroll")}), body: new (T$.ValueListenableBuilderOfMapOfString$dynamic()).new({valueListenable: main.dataService.tableStateNotifier, builder: dart.fn((_, value, __) => {
              switch (value[$_get]("status")) {
                case C[2] || CT.C2:
                  {
                    return new basic.Center.new({child: new text.Text.new("1.Toque em um dos botoes abaixo")});
                  }
                case C[3] || CT.C3:
                  {
                ...
                case C[4] || CT.C4:
                  {
                    return new main.ListWidget.new({jsonObjects: core.List.as(value[$_get]("dataObjects")), propertyNames: T$.ListOfString().as(value[$_get]("propertyNames")), displayedItemCount: core.int.as(dart.dload(value[$_get]("dataObjects"), 'length')), scrollEndedCallback: this.functionsMap[$_get](value[$_get]("itemType"))});
                  }
                case C[5] || CT.C5:
                  {
                    return new text.Text.new("Erro ao carregar a lista");
                  }
              }
              return new text.Text.new("...");
            }, T$.BuildContextAndMapOfString$dynamicAndWidgetNToWidget())}), bottomNavigationBar: new main.NewNavBar.new({itemSelectedCallback: dart.bind(main.dataService, 'carregar')})})});
    }
    static ['_#new#tearOff']() {
  ...
  (main.MyApp.new = function() {
    this[functionsMap] = new (T$.LinkedMapOfItemType$VoidTovoid()).from([main.ItemType.beer, dart.bind(main.dataService, 'carregarCervejas'), main.ItemType.coffee, dart.bind(main.dataService, 'carregarCafes'), main.ItemType.nation, dart.bind(main.dataService, 'carregarNacoes')]);
  ...
  dart.setFieldSignature(main.MyApp, () => ({
    ...
    functionsMap: dart.finalFieldType(core.Map$(main.ItemType, dart.fnType(dart.void, [])))
  }));
  ...
  main.NewNavBar = class NewNavBar extends framework$.HookWidget {
    ...
    build(context) {
      ...
      return new bottom_navigation_bar.BottomNavigationBar.new({onTap: dart.fn(index => {
          let t6;
          state.value = index;
          t6 = main.ItemType.values[$_get](index);
          dart.dsend(this, _itemSelectedCallback, [t6]);
        }, T$.intTovoid()), currentIndex: state.value, items: C[11] || CT.C11});
    }
  };
  (main.NewNavBar.new = function(opts) {
    let t6;
    let itemSelectedCallback = opts && 'itemSelectedCallback' in opts ? opts.itemSelectedCallback : null;
    this[_itemSelectedCallback] = (t6 = itemSelectedCallback, t6 == null ? dart.wrapType(core.int) : t6);
  ...
  var jsonObjects$ = dart.privateName(main, "ListWidget.jsonObjects");
  var propertyNames$ = dart.privateName(main, "ListWidget.propertyNames");
  var displayedItemCount$ = dart.privateName(main, "ListWidget.displayedItemCount");
  var _scrollEndedCallback = dart.privateName(main, "_scrollEndedCallback");
  main.ListWidget = class ListWidget extends framework$.HookWidget {
    get jsonObjects() {
    ...
    set displayedItemCount(value) {
      super.displayedItemCount = value;
    }
    static ['_#new#tearOff'](opts) {
      let jsonObjects = opts && 'jsonObjects' in opts ? opts.jsonObjects : C[21] || CT.C21;
      let propertyNames = opts && 'propertyNames' in opts ? opts.propertyNames : C[22] || CT.C22;
      let displayedItemCount = opts && 'displayedItemCount' in opts ? opts.displayedItemCount : 0;
      let scrollEndedCallback = opts && 'scrollEndedCallback' in opts ? opts.scrollEndedCallback : null;
      return new main.ListWidget.new({jsonObjects: jsonObjects, propertyNames: propertyNames, displayedItemCount: displayedItemCount, scrollEndedCallback: scrollEndedCallback});
    }
    build(context) {
      let controller = hooks.useScrollController();
      hooks.useEffect(dart.fn(() => {
        controller.addListener(dart.fn(() => {
          if (controller.position.pixels === controller.position.maxScrollExtent) core.print("end of scroll");
          if (core.Function.is(this[_scrollEndedCallback])) dart.dsend(this, _scrollEndedCallback, []);
        }, T$.VoidTovoid()));
      }, T$.VoidToNull()), T$.JSArrayOfObjectN().of([controller]));
      return new basic.Column.new({children: T$.JSArrayOfWidget().of([new text.Text.new("Total de Itens Carregados: " + dart.str(this.displayedItemCount)), new basic.Expanded.new({child: new scroll_view.ListView.separated({controller: controller, padding: new edge_insets.EdgeInsets.all(10), separatorBuilder: dart.fn((_, __) => new divider.Divider.new({height: 5, thickness: 2, indent: 10, endIndent: 10, color: theme.Theme.of(context).primaryColor}), T$.BuildContextAndintToDivider()), itemCount: this.jsonObjects[$length] + 1, itemBuilder: dart.fn((_, index) => {
                if (index === this.jsonObjects[$length]) return new basic.Center.new({child: new progress_indicator.LinearProgressIndicator.new()});
                let title = dart.dsend(this.jsonObjects[$_get](index), '_get', [this.propertyNames[$_get](0)]);
                let content = this.propertyNames[$sublist](1)[$map](dart.dynamic, dart.fn(prop => dart.dsend(this.jsonObjects[$_get](index), '_get', [prop]), T$.StringTodynamic()))[$join](" - ");
                return new card.Card.new({shadowColor: theme.Theme.of(context).primaryColor, child: new basic.Column.new({children: T$.JSArrayOfWidget().of([new basic.SizedBox.new({height: 10}), new text.Text.new(dart.str(title) + "\n", {style: new text_style.TextStyle.new({fontWeight: ui.FontWeight.bold})}), new text.Text.new(content), new basic.SizedBox.new({height: 10})])})});
              }, T$.BuildContextAndintToWidget())})})])});
    }
  };
  (main.ListWidget.new = function(opts) {
    let t6;
    let jsonObjects = opts && 'jsonObjects' in opts ? opts.jsonObjects : C[21] || CT.C21;
    let propertyNames = opts && 'propertyNames' in opts ? opts.propertyNames : C[22] || CT.C22;
    let displayedItemCount = opts && 'displayedItemCount' in opts ? opts.displayedItemCount : 0;
    ...
    this[_scrollEndedCallback] = (t6 = scrollEndedCallback, t6 == null ? false : t6);
    main.ListWidget.__proto__.new.call(this);
    ;
  }).prototype = main.ListWidget.prototype;
  dart.addTypeTests(main.ListWidget);
  dart.addTypeCaches(main.ListWidget);
  dart.setMethodSignature(main.ListWidget, () => ({
    __proto__: dart.getMethods(main.ListWidget.__proto__),
    build: dart.fnType(framework.Widget, [framework.BuildContext])
  }));
  dart.setLibraryUri(main.ListWidget, I[0]);
  dart.setFieldSignature(main.ListWidget, () => ({
    __proto__: dart.getFields(main.ListWidget.__proto__),
    [_scrollEndedCallback]: dart.finalFieldType(dart.dynamic),
    jsonObjects: dart.finalFieldType(core.List),
    propertyNames: dart.finalFieldType(core.List$(core.String)),
    displayedItemCount: dart.finalFieldType(core.int)
  }));
